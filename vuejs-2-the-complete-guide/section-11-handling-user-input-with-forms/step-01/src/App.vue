            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" class="form-control" v-model.lazy="userData.password"> {{userData.password}}
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
                    ...
                    <select id="priority" class="form-control" v-model="selectedPriority">
                        <option v-for="(priority, key) in priorities" :key="key">{{priority}}</option>
                    </select>
                </div>
            </div>
            <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul>
                            <li v-for="(item, index) in sendMailOrdered" :key="index">{{item}}</li>
                        </ul>
                        <p>Gender: {{gender}}</p>
...
export default {
    ...
    computed: {
        sendMailOrdered: function() {
            return this.sendMail.sort();
        }
    },
    data: function() {
        return {
            ...
            message: 'A new message here',
            sendMail: [],
            gender: 'Male',
            selectedPriority: 'Médio',
            priorities: [
                'Baixo', 'Médio', 'Alto'
            ],
            dataSwitch: true,
